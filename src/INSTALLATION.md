...
You have to be careful while typing the paths of your own files. The template is given in the file but not descripted. [Here](CONFIGURATING.md) is the description.
